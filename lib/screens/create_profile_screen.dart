...
class CreateProfileSC extends StatefulWidget {
  static String nameScreen = "CreateProfileSC";

  @override
  _CreateProfileSCState createState() => _CreateProfileSCState();
}

class _CreateProfileSCState extends State<CreateProfileSC> {
                      ...
                      children: <Widget>[
                        Flexible(
                          child: Container(
                            ...
                            child: Text(
                              mainUserInterfaceLanguage["header_create_profile"],
                              style: TextStyle(
